...
src_install() {
	...
	dosbin bcachefs
	into /
	dosym -r /usr/sbin/bcachefs /usr/sbin/fsck.bcachefs
	dosym -r /usr/sbin/bcachefs /usr/sbin/mkfs.bcachefs
	dosym -r /usr/sbin/bcachefs /usr/sbin/mount.bcachefs

	if use fuse; then
		# TODO this probably needs more fixing
