...
inherit eutils scons-utils toolchain-funcs flag-o-matic git-r3
...
EGIT_REPO_URI="https://github.com/apache/serf.git"
...
src_prepare() {
	...
	epatch "${FILESDIR}/${PN}-9999-static-lib.patch"
	epatch "${FILESDIR}/${PN}-9999-kill-unneeded-rpath.patch"
...
src_configure() {
	...
	if use kerberos; then
		MYSCONS+=( GSSAPI="${SYSROOT}${EPREFIX}/usr/bin/krb5-config" )
	fi
}
