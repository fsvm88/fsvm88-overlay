...
RDEPEND="
	>=dev-libs/glib-2.62.6:2[${MULTILIB_USEDEP}]
	>=x11-libs/cairo-1.16.0-r3[${MULTILIB_USEDEP}]
	>=x11-libs/pango-1.42.4-r2[${MULTILIB_USEDEP}]
	>=dev-libs/libxml2-2.9.9-r3:2[${MULTILIB_USEDEP}]
	>=x11-libs/gdk-pixbuf-2.40.0:2[introspection?,${MULTILIB_USEDEP}]
...
DEPEND="${RDEPEND}
	...
	>=virtual/pkgconfig-1[${MULTILIB_USEDEP}]
	vala? ( $(vala_depend) )
"
