...
PATCHES=(
	...
	"${FILESDIR}/${PN}-6.3.0-backport-971fd66.patch"
	"${FILESDIR}/${PN}-6.3.0-backport-91c18ff.patch"
	"${FILESDIR}/${PN}-6.3.0-setAllowTemporaryLabels-was-removed.patch"
	"${FILESDIR}/${PN}-6.3.0-include-moved-Module_h.patch"
)
