...
src_prepare() {
	...
	# Patch for BPF+Capstone compat, backported from upstream
	eapply "${FILESDIR}"/perf-6.10-backport-bpf-capstone-compat.patch
	# Patch to make clang+llvm checks actually work, backported from 6.11
	# https://github.com/torvalds/linux/commit/56b11a2126bf2f422831ecf6112b87a4485b221b.patch
	#eapply "${FILESDIR}"/perf-6.10.3-remove-embedding-clang.patch
	popd || die
